                ...
                <form id="formUbah">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="id_asset_edit" name="id_asset" autocomplete="off" minlength="1" maxlength="10" onkeyup="splitInDots(this)" onKeyPress="return goodchars(event,'0123456789',this)">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                     ...
                                     <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="tanggal_pemeriksaan_edit" name="tanggal_pemeriksaan" autocomplete="off" value="<?php echo date("d-m-Y"); ?>">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kategori_edit" name="kategori" autocomplete="off" minlength="1" maxlength="25">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="komputer_type_edit" name="komputer_type" autocomplete="off" minlength="1" maxlength="50">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="connectivity_edit" name="connectivity" autocomplete="off" minlength="1" maxlength="20">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="internet_edit" name="internet" autocomplete="off" minlength="1" maxlength="5">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="user_edit" name="user" autocomplete="off" minlength="1" maxlength="50">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="location_edit" name="location" autocomplete="off" minlength="1" maxlength="50">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label>Link To</label>
                            <input type="text" class="form-control" id="link_to_edit" name="link_to" autocomplete="off" minlength="1" maxlength="50">
                    ...
                    <div class="col-sm-3">
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="maint_date_edit" name="maint_date" autocomplete="off" value="<?php echo date("d-m-Y"); ?>">
                     </div>
                 </div>
             </div>
