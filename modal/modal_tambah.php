    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> Input Data Asset</h5>
                   ...
                   <div class="col-sm-12">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password_add" name="password" autocomplete="off" minlength="1" maxlength="20">
                        </div>
                    </div>
